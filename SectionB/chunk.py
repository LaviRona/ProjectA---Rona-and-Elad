...
# Window sizing in *words*. Empirically (see RESULTS.md), larger windows with
# bigger stride score better here — fewer, less-redundant passages make a
# cleaner page centroid. 384/64 won the chunk-size sweep.
CHUNK_WORDS = 384
OVERLAP_WORDS = 64
